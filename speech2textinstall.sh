...
LF=$(printf '\\\012_')
LF=${LF%_}
EXTENSION_NAME=Speech2Text
EXTENSION_ID=speech2text
EXTENSION_ICON_NAME=speech
COLLABORATOR=Google
EXTENSION_DESCRIPTION="Speech to Text Extension"
...
sed -e "s|^export default \[$|import ${EXTENSION_ID}IconURL from './${EXTENSION_ID}/${EXTENSION_ICON_NAME}.png';${LF}${LF}export default [${LF}${DESCRIPTION}|g" src/lib/libraries/extensions/index.jsx_orig > src/lib/libraries/extensions/index.jsx
